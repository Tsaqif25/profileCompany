...
Route::get('/appointement', [FrontController::class, 'appointement'])->name('front.appointement');
Route::post('/appointement/store', [FrontController::class, 'appointement_store'])->name('front.appointement_store');
