...
class OurPrincipleController extends Controller
{
    ...
    {
        $principle = OurPrinciple::orderByDesc('id')->paginate(10);
        return view('admin.principles.index',compact('principle'));
    ...
    {
        $principle->delete();
        return redirect()->route('admin.principles.index')->with('success', 'Prinsip berhasil dihapus');
    }
}
