            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($appointment->product->thumbnail) }}" alt="{{ $appointment->product->name }}" class="rounded-2xl object-cover w-[120px] h-[90px]">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col gap-y-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ date('m/d/Y', strtotime($appointment->meeting_at)) }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <a href="https://wa.me/{{ preg_replace('/^0/', '62', $appointment->phone_number) }}?text=Halo%20{{ urlencode($appointment->name) }},%20saya%20melihat%20Anda%20tertarik%20dengan%20produk%20{{ urlencode($appointment->product->name) }}.%20Mohon%20dikonfirmasi%20terkait%20booking%20ini."
                    target="_blank" 
