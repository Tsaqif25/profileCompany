            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.clients.update', $client) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="occupation" class="block mt-1 w-full" type="text" name="occupation" value="{{ old('occupation', $client->occupation) }}" required autofocus autocomplete="occupation" />
                        <x-input-error :messages="$errors->get('occupation')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="avatar" :value="__('Avatar')" />
                        <img src="{{ Storage::url($client->avatar) }}" alt="{{ $client->name }}" class="rounded-2xl object-cover w-[90px] h-[90px] mb-4">
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($client->logo) }}" alt="{{ $client->name }}" class="rounded-2xl object-cover w-[90px] h-[90px] mb-4">
