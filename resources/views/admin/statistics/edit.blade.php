                ...
                <form method="POST" action="{{ route('admin.statistics.update', $statistic->id) }}" enctype="multipart/form-data"> 
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" 
                          value="{{ old('name', $statistic->name) }}" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        @if($statistic->icon)
                            <img src="{{ asset('storage/'.$statistic->icon) }}" alt="{{ $statistic->name }}" class="rounded-2xl object-cover w-[90px] h-[90px]">
                        @endif
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="goal" class="block mt-1 w-full" type="text" name="goal" 
                          value="{{ old('goal', $statistic->goal) }}" required autofocus autocomplete="goal" />
